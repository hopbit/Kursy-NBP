package info.siwinski.kusynpb.activities;

import info.siwinski.kusynpb.model.ExchangeRate;
import info.siwinski.kusynpb.utils.ValidatorUtil;
...
public class StartApplicationActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
    	...
    	if (checkDataAvailabilityOnDevice()) {
							...
							.setPositiveButton("Tak", new DialogInterface.OnClickListener() {
								public void onClick(DialogInterface dialog, int id) {
									...
									downloadButton.setOnClickListener(new Button.OnClickListener(){
										public void onClick(View v) {
											startActivity(new Intent("info.siwinski.kursywalut.activities.DOWNLOAD"));
										}
					        	   });
					           }
    		...
    		downloadButton.setOnClickListener(new Button.OnClickListener(){
				public void onClick(View v) {
					startActivity(new Intent("info.siwinski.kursynbp.activities.DOWNLOAD"));
				}
			});
	...
	private Double calculateRateMagicBox(Double inputValue,
		...
		} else if (!RATE_PLN.equals(codeFrom) && !RATE_PLN.equals(codeTo)) { // WZîR 3
